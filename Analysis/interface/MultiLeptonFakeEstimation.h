#ifndef __MultiLeptonFakeEstimation__hh
#define __MultiLeptonFakeEstimation__hh
...
class MultiLeptonFakeEstimation : public PhysicsObjSelector {
    
public:
  enum class EventType {
    unkwn = -1, mmem = 0, eeem
  };
  MultiLeptonFakeEstimation();
  virtual ~MultiLeptonFakeEstimation();
