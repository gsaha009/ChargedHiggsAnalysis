#ifndef __MultiLeptonDYControl__hh
#define __MultiLeptonDYControl__hh
...
class MultiLeptonDYControl : public PhysicsObjSelector {
    
public:
  enum class EventType {
    unkwn = -1, mmem = 0, eeem
  };
  MultiLeptonDYControl();
  virtual ~MultiLeptonDYControl();
